...
![New ASP.Net Project](/assets/images/social-login-owin-authentication-mvc5/new-aspnet-project.png)
...
![Create New Project WebApplication](~/assets/images/social-login-owin-authentication-mvc5/create-new-project-webapplication.png)

In the change authentication window we will use Individual User Accounts.

![Change Authentication](~/assets/images/social-login-owin-authentication-mvc5/change-authentication.png)
...
![Create Facebook App](~/assets/images/social-login-owin-authentication-mvc5/create-facebook-app.png)
...
![Configurate Facebook App](~/assets/images/social-login-owin-authentication-mvc5/configure-facebook-app.png)
